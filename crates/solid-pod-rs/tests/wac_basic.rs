//! WAC smoke tests.
//!
//! Covers the four scenarios called out in the sprint spec:
//! - agent with `acl:Read` can GET
//! - agent without grant returns 403 (evaluate_access returns false)
//! - `foaf:Agent` public grant allows anonymous read
//! - container `acl:default` inherits to children
