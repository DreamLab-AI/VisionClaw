...
| **NEW-I3** | Kind 30023 collision | VisionClaw + forum | Multiple | VisionClaw uses kind 30023 for migration approvals; forum uses it for NIP-23 long-form content. Same relay → indistinguishable events. |
