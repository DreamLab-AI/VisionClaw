...
| [ADR-2040](ADR-2040-obsidian-vault-frontmatter-gate.md) | The authored corpus is an Obsidian vault; YAML frontmatter `public`/`owl-class` gate KG inclusion with bounded Logseq tolerance | VAULT-corpus-format | 2026-09-02 | proposed | partial | staged | ADR-2014 | ADR-2112 | jjohare | visionclaw |
| [ADR-2041](ADR-2041-graph-settings-key-knowledge.md) | The knowledge-graph settings key and graph-type value are `knowledge`; `logseq` is a read-only alias for one release | VAULT-corpus-format | 2026-09-02 | proposed | complete | staged | — | ADR-2115 | jjohare | visionclaw |
...
| [ADR-2096](ADR-2096-local-file-sync-uses-the-vault-parsing-entry-point.md) | Route local file sync's inclusion gate through the vault parsing entry point | VAULT-corpus-format | 2026-09-05 | accepted | complete | live | — | ADR-2114 | jjohare | visionclaw |
...
| [ADR-2112](ADR-2112-vault-corpus-format-v2-frontmatter-only-okf.md) | The corpus is frontmatter-only OKF governed by a versioned `ontology/vocabulary.yaml`; the json-ld fences and every Logseq construct are deleted, not tolerated | VAULT-corpus-format | 2026-09-22 | accepted | partial | staged | ADR-2040 | — | jjohare | visionclaw |
| [ADR-2113](ADR-2113-crates-vault-is-the-single-corpus-parser-and-build.md) | crates/vault is the single corpus parser and build | — | 2026-09-22 | accepted | partial | staged | — | — | jjohare | visionclaw |
